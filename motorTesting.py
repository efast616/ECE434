...
@blynk.on("V3")
def v3_write_handler("V3"):
	frequencyA = args[0]
#	frequencyA = 1/(args[0])    	#try this line if it is not working chart of input signals says 1/PWM

@blynk.on("V4")
def v4_write_handler("V4"):
	frequencyB = args[0]
#	frequencyB = args[0]		#try this line if it is not working chart of input signals says 1/PWM
...
#	time.sleep(10)
	...
	print(,  frequencyB)		#debug print statements
